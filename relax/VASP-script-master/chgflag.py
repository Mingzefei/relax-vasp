...
if '-h' in sys.argv:
    print('usage : chgflag.py num_1,num_2,... T/F vaspfile')
    print('example : chgflag.py 2,5,10-13,22 F POSCAR')
    print('descr : 将POSCAR文件中第2个、第5个、第10-13个以及第22个原子的驰豫标记变为`F F F`')
